...
/*   Updated: 2026/04/10 07:44:49 by sklaokli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test2_deep_copy_constructor() {
  ...
  if (original[0] != copy[0])
    ...
    std::cout << "\033[1;31mFAILURE: Shallow copy detected!\033[0m"
              << std::endl;
}
...
void test3_assignment_operator() {
  ...
  if (a[1] != b[1])
    std::cout << "\033[1;32mSUCCESS: Assignment deep copy verified!\033[0m"
              << std::endl;
}
...
void test4_exception_handling() {
  ...
  try {
    ...
    std::cout << "\033[1;31mCaught expected error: \033[0m" << e.what()
              << std::endl;
  }
}
...
void test5_const_array() {
  ...
  std::cout << "Const access index 0: " << c_arr[0]
            << " \033[0;32m(Read-only OK)\033[0m" << std::endl;
}
